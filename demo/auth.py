...
#CLIENT_ID = 'rx48zwkumuhxksnxdeoq7ziwgt8l0tbq'  # Insert Box client ID here
#CLIENT_SECRET = 'yw70fHS5LU8TZFeHFhJXxwEBM0ZjPW8n'  # Insert Box client secret here

def authenticate(client_id, client_secret, oauth_class=OAuth2, use_port=8080):
    ...
    local_server = StoppableWSGIServer(host='localhost', port=use_port)
    ...
    auth_url, csrf_token = oauth.get_authorization_url('http://localhost:'+str(use_port))
